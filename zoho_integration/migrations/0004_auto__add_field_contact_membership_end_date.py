...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.membership_end_date'
        db.add_column(u'zoho_integration_contact', 'membership_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.membership_end_date'
        db.delete_column(u'zoho_integration_contact', 'membership_end_date')
