...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('crm', ['CRMPerson'])

        # Adding model 'PayPal'
        db.create_table('crm_paypal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('crm', ['PayPal'])

        # Adding model 'Cash'
        db.create_table('crm_cash', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['crm.CRMPerson'], unique=True, null=True)),
            ('paid_up_until', self.gf('django.db.models.fields.DateField')(blank=True)),
        ))
        db.send_create_signal('crm', ['Cash'])
        ...
        db.create_table('crm_emailrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('crm', ['EmailRecord'])


    def backwards(self, orm):
        # Deleting model 'CRMPerson'
        db.delete_table('crm_crmperson')

        # Deleting model 'PayPal'
        db.delete_table('crm_paypal')

        # Deleting model 'Cash'
        db.delete_table('crm_cash')

        # Deleting model 'Note'
        db.delete_table('crm_note')

        # Deleting model 'EmailRecord'
        db.delete_table('crm_emailrecord')
    ...
    models = {
        ...
        'crm.crmperson': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_check_1': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'id_checker_1'", 'unique': 'True', 'null': 'True', 'to': "orm['accounts.PS1User']"}),
            'id_check_2': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'id_checker_2'", 'unique': 'True', 'null': 'True', 'to': "orm['accounts.PS1User']"}),
