...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'crm_crmperson', ['id_check_2_id'])

        # Removing unique constraint on 'CRMPerson', fields ['id_check_1']
        db.delete_unique(u'crm_crmperson', ['id_check_1_id'])


        # Changing field 'CRMPerson.id_check_1'
        db.alter_column(u'crm_crmperson', 'id_check_1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.PS1User']))

        # Changing field 'CRMPerson.id_check_2'
        db.alter_column(u'crm_crmperson', 'id_check_2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.PS1User']))

    def backwards(self, orm):

        # Changing field 'CRMPerson.id_check_1'
        db.alter_column(u'crm_crmperson', 'id_check_1_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['accounts.PS1User']))
        # Adding unique constraint on 'CRMPerson', fields ['id_check_1']
        db.create_unique(u'crm_crmperson', ['id_check_1_id'])


        # Changing field 'CRMPerson.id_check_2'
        db.alter_column(u'crm_crmperson', 'id_check_2_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['accounts.PS1User']))
        # Adding unique constraint on 'CRMPerson', fields ['id_check_2']
        db.create_unique(u'crm_crmperson', ['id_check_2_id'])
