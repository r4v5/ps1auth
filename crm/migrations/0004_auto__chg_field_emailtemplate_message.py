...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crm_emailtemplate', 'message', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'EmailTemplate.message'
        db.alter_column(u'crm_emailtemplate', 'message', self.gf('django.db.models.fields.TextField')())
