...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'crm_crmperson', 'id_check_1_id')

        # Deleting field 'CRMPerson.id_check_2'
        db.delete_column(u'crm_crmperson', 'id_check_2_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'crm_crmperson', 'id_check_1',
        ...
        db.add_column(u'crm_crmperson', 'id_check_2',
