...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('crm_emailattachement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachements', to=orm['crm.EmailTemplate'])),
            ('attachement', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('crm', ['EmailAttachement'])

        # Adding model 'EmailTemplate'
        db.create_table('crm_emailtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('crm', ['EmailTemplate'])


        # Changing field 'EmailRecord.reply_to_email'
        db.alter_column('crm_emailrecord', 'reply_to_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

    def backwards(self, orm):
        # Deleting model 'EmailAttachement'
        db.delete_table('crm_emailattachement')

        # Deleting model 'EmailTemplate'
        db.delete_table('crm_emailtemplate')


        # Changing field 'EmailRecord.reply_to_email'
        db.alter_column('crm_emailrecord', 'reply_to_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
