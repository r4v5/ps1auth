...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crm_emailrecord', 'reply_to_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EmailRecord.reply_to_email'
        db.alter_column(u'crm_emailrecord', 'reply_to_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        ...
        u'crm.emailattachement': {
            ...
            'email': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attachements'", 'to': u"orm['crm.EmailTemplate']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'crm.emailrecord': {
