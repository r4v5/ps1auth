...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailTemplate.from_name'
        db.add_column(u'crm_emailtemplate', 'from_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EmailTemplate.reply_to_name'
        db.add_column(u'crm_emailtemplate', 'reply_to_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailTemplate.from_name'
        db.delete_column(u'crm_emailtemplate', 'from_name')

        # Deleting field 'EmailTemplate.reply_to_name'
        db.delete_column(u'crm_emailtemplate', 'reply_to_name')
