...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'crm_crmperson', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CRMPerson.city'
        db.alter_column(u'crm_crmperson', 'city', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'CRMPerson.birthday'
        db.alter_column(u'crm_crmperson', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CRMPerson.email'
        db.alter_column(u'crm_crmperson', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'CRMPerson.street_address'
        db.alter_column(u'crm_crmperson', 'street_address', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'CRMPerson.zip_code'
        db.alter_column(u'crm_crmperson', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):
        # Deleting field 'CRMPerson.country'
        db.delete_column(u'crm_crmperson', 'country')


        # Changing field 'CRMPerson.city'
        db.alter_column(u'crm_crmperson', 'city', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 11, 1, 0, 0), max_length=128))

        # Changing field 'CRMPerson.birthday'
        db.alter_column(u'crm_crmperson', 'birthday', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 11, 1, 0, 0)))

        # Changing field 'CRMPerson.email'
        db.alter_column(u'crm_crmperson', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'CRMPerson.street_address'
        db.alter_column(u'crm_crmperson', 'street_address', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

        # Changing field 'CRMPerson.zip_code'
        db.alter_column(u'crm_crmperson', 'zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
