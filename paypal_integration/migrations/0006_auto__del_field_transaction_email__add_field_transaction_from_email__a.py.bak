...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'paypal_integration_transaction', 'email')

        # Adding field 'Transaction.from_email'
        db.add_column(u'paypal_integration_transaction', 'from_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)

        # Adding field 'Transaction.to_email'
        db.add_column(u'paypal_integration_transaction', 'to_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'paypal_integration_transaction', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)

        # Deleting field 'Transaction.from_email'
        db.delete_column(u'paypal_integration_transaction', 'from_email')

        # Deleting field 'Transaction.to_email'
        db.delete_column(u'paypal_integration_transaction', 'to_email')
