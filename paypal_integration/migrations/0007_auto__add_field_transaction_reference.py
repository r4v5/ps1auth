...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'paypal_integration_transaction', 'reference',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'paypal_integration_transaction', 'reference_id')
    ...
    models = {
        u'paypal_integration.transaction': {
            ...
            'reference': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['paypal_integration.Transaction']", 'null': 'True'}),
