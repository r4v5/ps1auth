...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('paypal_integration_transaction', 'balance_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(),
                      keep_default=False)

        # Adding field 'Transaction.balance'
        db.add_column('paypal_integration_transaction', 'balance',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('paypal_integration_transaction', 'balance_currency')

        # Deleting field 'Transaction.balance'
        db.delete_column('paypal_integration_transaction', 'balance')
