...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'paypal_integration_transaction', 'status', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Transaction.type'
        db.alter_column(u'paypal_integration_transaction', 'type', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Transaction.type'
        db.alter_column(u'paypal_integration_transaction', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))
