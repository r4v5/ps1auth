...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RFIDNumber.ASCII_125khz'
        db.add_column(u'rfid_rfidnumber', 'ASCII_125khz',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RFIDNumber.ASCII_125khz'
        db.delete_column(u'rfid_rfidnumber', 'ASCII_125khz')
