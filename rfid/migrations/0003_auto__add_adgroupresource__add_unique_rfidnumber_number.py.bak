...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rfid_adgroupresource', (
            (u'resource_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rfid.Resource'], unique=True, primary_key=True)),
            ('ad_group', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'rfid', ['AdGroupResource'])

        # Adding unique constraint on 'RFIDNumber', fields ['number']
        db.create_unique(u'rfid_rfidnumber', ['number'])


    def backwards(self, orm):
        # Removing unique constraint on 'RFIDNumber', fields ['number']
        db.delete_unique(u'rfid_rfidnumber', ['number'])

        # Deleting model 'AdGroupResource'
        db.delete_table(u'rfid_adgroupresource')
